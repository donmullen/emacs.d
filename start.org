#+TITLE: Emacs 24 configuration for Don Mullen
#+AUTHOR: Clinton Dreisbach, with modifications by Don Mullen
#+EMAIL:  donmullen@gmail.com
#+OPTIONS: toc:2 num:nil

* TODO
- markdown-css-path is deprecated, see markdown-css-paths
* Possible Additions
- clojure-refactor
...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Don Mullen")
  (setq user-mail-address "donmullen@gmail.com")
#+END_SRC
...
;; http://malabarba.github.io/emacs-archive-tracker/
...
#+BEGIN_SRC emacs-lisp
  (defvar cnd/packages '(;; adoc-mode
                         ...
                         ;; projectile ;; code project management
                         ;; python-mode
                         qsimpleq-theme
                         rainbow-delimiters
                         sass-mode
...
** Ag
Turn on highlight support for Ag. (Silver Searcher)
#+begin_src emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; I like underlined semi-bold links
  (custom-set-faces
...
From :  https://github.com/ronert/.emacs.d/blob/master/init-smartparens.el
And from author's default configuration :  https://github.com/Fuco1/smartparens/wiki/Example-configuration
...
** Clojure
   I want Emacs to open up ClojureScript and Hoplon files with Clojure syntax.

   I want smartparens when I am editing Clojure files as well as
   rainbow delimiters.
...
#+BEGIN_SRC emacs-lisp
  ...
  (define-clojure-indent  (action :defn) (dom/a :defn) (dom/abbr :defn) (dom/address :defn) (dom/area :defn) (dom/article :defn) (dom/aside :defn) (dom/audio :defn) (dom/b :defn) (dom/base :defn) (dom/bdi :defn) (dom/bdo :defn) (dom/big :defn) (dom/blockquote :defn) (dom/body :defn) (dom/br :defn) (dom/button :defn) (dom/canvas :defn) (dom/caption :defn) (dom/cite :defn) (dom/code :defn) (dom/col :defn) (dom/colgroup :defn) (dom/data :defn) (dom/datalist :defn) (dom/dd :defn) (dom/del :defn) (dom/details :defn) (dom/dfn :defn) (dom/dialog :defn) (dom/dl :defn) (dom/dt :defn) (dom/em :defn) (dom/embed :defn) (dom/fieldset :defn) (dom/figcaption :defn) (dom/figure :defn) (dom/footer :defn) (dom/form :defn) (dom/h1 :defn) (dom/h2 :defn) (dom/h3 :defn) (dom/h4 :defn) (dom/h5 :defn) (dom/h6 :defn) (dom/head :defn) (dom/header :defn) (dom/hr :defn) (dom/html :defn) (dom/i :defn) (dom/iframe :defn) (dom/img :defn) (dom/ins :defn) (dom/kbd :defn) (dom/keygen :defn) (dom/label :defn) (dom/legend :defn) (dom/li :defn) (dom/link :defn) (dom/main :defn) (dom/map :defn) (dom/mark :defn) (dom/menu :defn) (dom/menuitem :defn) (dom/meta :defn) (dom/meter :defn) (dom/nav :defn) (dom/noscript :defn) (dom/object :defn) (dom/ol :defn) (dom/optgroup :defn) (dom/output :defn) (dom/p :defn) (dom/param :defn) (dom/picture :defn) (dom/pre :defn) (dom/progress :defn) (dom/q :defn) (dom/rp :defn) (dom/rt :defn) (dom/ruby :defn) (dom/s :defn) (dom/samp :defn) (dom/script :defn) (dom/section :defn) (dom/small :defn) (dom/source :defn) (dom/span :defn) (dom/strong :defn) (dom/style :defn) (dom/sub :defn) (dom/summary :defn) (dom/sup :defn) (dom/table :defn) (dom/tbody :defn) (dom/td :defn) (dom/tfoot :defn) (dom/th :defn) (dom/thead :defn) (dom/time :defn) (dom/title :defn) (dom/tr :defn) (dom/track :defn) (dom/u :defn) (dom/ul :defn) (dom/var :defn) (dom/video :defn) (dom/wbr :defn) (dom/div :defn) (testing '(:defn (1))) (specification '(:defn (1))) (behaviour '(:defn (1))) (defui '(:defn (1))) (defsc '(:defn (1)))) 
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-M-S-x") 'smex-major-mode-commands)
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "M-m")  'iconify-frame)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;
  ;; keybinding management from SmartParens Author
...
** OS X Full Screen
  ...
  Add full screen toggle support - should work in most Mac versions of Emacs.
...
Switched from Ubuntu Mono derivative Powerline to Anonymous Pro
...
#+BEGIN_SRC emacs-lisp
    (when (eq system-type 'darwin)
      ...
      ;;;              :family "Anonymous Pro" :height 180 :weight 'normal)

      ;;; http://sourcefoundry.org/hack/

      ;;; http://www.fontsquirrel.com/fonts/fira-mono
      (set-face-attribute 'default nil
                    :family "Fira Mono" :height 180 :weight 'normal)
...
** Additional OS X stuff from emacs-live

  Ensure copy/paste works (not sure this is necessary anymore.
  System-name work-around
